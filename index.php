            ...
            <div class="col-md-3 p-3">
                <div class="card">
                    ...
                    <ul id="indexanchor" class="card-body">
                        <li><a href="./views/viewcategories.html?cat=App_development">App development</a></li>
                        <li><a href="./views/viewcategories.html?cat=Graphic_design">Graphic design</a></li>
                        <li><a href="./views/viewcategories.html?cat=Database_tips">Database tips</a></li>
                        <li><a href="./views/viewcategories.html?cat=Tech_gist">Tech gist</a></li>
                        <li><a href="./views/viewcategories.html?cat=Business">Business</a></li>
                    </ul>
                </div>
            </div>
        </div>
